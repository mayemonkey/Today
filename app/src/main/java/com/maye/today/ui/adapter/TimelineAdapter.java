...
public class TimelineAdapter extends BaseQuickAdapter<Record, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, Record record) {
        ...
        if (i >= 0){    //未完成
            helper.setBackgroundResource(R.id.iv_line_point, R.drawable.shape_home_circle_blue);
        }else {         //已完成
            helper.setBackgroundResource(R.id.iv_line_point, R.drawable.shape_home_circle_purple);
        }
