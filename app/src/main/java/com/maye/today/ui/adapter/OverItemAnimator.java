...
public class OverItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).translationX(-1).setListener(new VpaListenerAdapter() {
            @Override
    ...
    public boolean animateAdd(final ViewHolder holder) {
        resetAnimation(holder);
        ViewCompat.setTranslationX(holder.itemView, -1);
