...
import com.maye.register.mvp.RegisterPresenter
import com.maye.register.mvp.RegisterPresenterImpl
import com.maye.register.mvp.RegisterView
...
class RegisterActivity : Activity(), RegisterView, View.OnClickListener {
    ...
    override fun startActivity() {
        startActivity(Intent(this, com.maye.login.ui.LoginActivity::class.java))
    }
